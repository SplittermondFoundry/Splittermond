...
import { migrateAutoGeneratedFlag } from "./migrations/migrateAutoGeneratedFlag";
...
export function initializeActiveEffects(config: typeof CONFIG) {
    ...
    config.ActiveEffect.dataModels = {
        ...
        autoGenerated: ActionEffectDataModel,
    };
    ...
    foundryApi.sheets.activeEffects.register("splittermond", SplittermondActiveEffectConfig, {
        types: ["modifier", "spellEffect", "spellEnhancedEffect", "attackEffect", "autoGenerated"],
        makeDefault: true,
    ...
    foundryApi.settings.register("splittermond", "autoGeneratedTypeMigrationDone", {
        scope: "world",
        config: false,
        type: Boolean,
        default: false,
    ...
    foundryApi.hooks.once("ready", () => {
        void migrateAutoGeneratedFlag().then(() => {
