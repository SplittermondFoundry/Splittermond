...
splittermond.damageLevel = [
    "splittermond.damageLevels.undamaged",
    "splittermond.damageLevels.tarnished",
    "splittermond.damageLevels.demolished",
    "splittermond.damageLevels.destroyed",
];

splittermond.skillGroups = skillGroups;

splittermond.resources = {
    core: ["reputation", "contacts", "state", "wealth"],
    optional: ["following", "faith", "creature", "mentor", "relic", "hideaway", "rank"],
};
