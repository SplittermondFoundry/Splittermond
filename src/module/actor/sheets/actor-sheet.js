 ...
 * @property {string|null} [sourceItemType]
 * @property {import('module/activeEffect/SplittermondActiveEffect').DurationMode} durationMode
...
export default class SplittermondActorSheet extends SplittermondBaseActorSheet {
    ...
    constructor(options) {
        const instanceDefaults = {
            actions: {
                ...
                "toggle-show-all-effects": () => this.#handleToggleShowAllEffects(),
            },
        };
    ...
    async _prepareContext(options) {
        ...
        sheetData.activeEffects = Array.from(this.actor.allApplicableEffects())
            .map((e) => ({
                ...
                sourceItemType: e.item?.type ?? null,
            ...
            .filter((e) => this._showAllEffects || showInDefaultView(e))
            .sort((a, b) => a.sort - b.sort);

        sheetData.showAllEffects = this._showAllEffects;
    ...
    /**
     * Handle toggling between the default and the all effects view
     */
    #handleToggleShowAllEffects() {
        this._showAllEffects = !this._showAllEffects;
        return this.render();
    }
