    ...
    (
        [
            [
                ...
                new Cost(4, 2, false),
                new PrimaryCost({ _nonConsumed: 7, _consumed: 3, _isChanneled: false }),
            ],
            [
                new PrimaryCost({
                    _nonConsumed: 0,
                ...
                new Cost(4, 0, false),
                new PrimaryCost({ _nonConsumed: 4, _consumed: 5, _isChanneled: false }),
            ],
            [
                new PrimaryCost({
                    _nonConsumed: 0,
                ...
                new Cost(0, 1, false),
                new PrimaryCost({ _nonConsumed: 0, _consumed: 2, _isChanneled: true }),
            ],
            [
                new PrimaryCost({
                    _nonConsumed: 0,
                ...
                new Cost(0, 1, true),
                new PrimaryCost({ _nonConsumed: 0, _consumed: 2, _isChanneled: false }),
            ],
            [
                new PrimaryCost({
                    _nonConsumed: 3,
                ...
                new Cost(0, 0, true),
                new PrimaryCost({ _nonConsumed: 3, _consumed: 1, _isChanneled: false }),
            ],
            [
                new PrimaryCost({
                    _nonConsumed: 0,
                ...
                new Cost(3, 0, true),
                new PrimaryCost({ _nonConsumed: 3, _consumed: 0, _isChanneled: false }),
            ],
            [
                new PrimaryCost({
                    _nonConsumed: 0,
                ...
                new Cost(0, 3, true),
                new PrimaryCost({ _nonConsumed: 0, _consumed: 6, _isChanneled: false }),
            ],
            [
                new PrimaryCost({
                    _nonConsumed: 100,
                ...
                new Cost(0, 1, true),
                new PrimaryCost({ _nonConsumed: 100, _consumed: 3001, _isChanneled: false }),
            ],
        ] as const
    ).forEach(([costs1, costs2, expected]) =>
    ...
    (
        [
            [
                ...
                new Cost(3, 1, false),
                new PrimaryCost({ _nonConsumed: 1, _consumed: 1, _isChanneled: false }),
            ],
            [
                new PrimaryCost({
                    _nonConsumed: 0,
                ...
                new Cost(4, 0, false),
                new PrimaryCost({ _nonConsumed: 0, _consumed: 5, _isChanneled: false }),
            ],
            [
                new PrimaryCost({
                    _nonConsumed: 0,
                ...
                new Cost(0, 1, false),
                new PrimaryCost({ _nonConsumed: 0, _consumed: 0, _isChanneled: true }),
            ],
            [
                new PrimaryCost({
                    _nonConsumed: 3,
                ...
                new Cost(0, 2, true),
                new PrimaryCost({ _nonConsumed: 2, _consumed: 0, _isChanneled: false }),
            ],
            [
                new PrimaryCost({
                    _nonConsumed: 0,
                ...
                new Cost(3, 0, true),
                new PrimaryCost({ _nonConsumed: 0, _consumed: 0, _isChanneled: false }),
            ],
            [
                new PrimaryCost({
                    _nonConsumed: 5,
                ...
                new Cost(0, 3, true),
                new PrimaryCost({ _nonConsumed: 5, _consumed: 0, _isChanneled: false }),
            ],
        ] as const
    ).forEach(([costs1, costs2, expected]) =>
        it(`substracting ${costs2} from ${costs1} yields ${expected}`, () => {
...
describe("BaseCost object rendering", () => {
    ...
    ).forEach(([costs, expected]) =>
        it(`should render ${costs} as ${expected}`, () => {
